...
from app.api.internal.law_ingest import router as law_internal_router  # noqa: F401
from app.api.internal.contract_ingest import router as contract_internal_router  # noqa: F401
...
from app.api.v1.legal_commands import legal_commands_router  # noqa: F401
from app.api.v1.benchmark import benchmark_router  # noqa: F401
from app.api.v1.template import template_router  # noqa: F401
from app.api.v1.compliance import compliance_router  # noqa: F401

# from app.api.v1.query import query_router  # noqa: F401
from app.api.v1.scope import scope_router  # noqa: F401

api_router = APIRouter()
api_router.include_router(law_internal_router, prefix="/internal/law", tags=["internal"])
api_router.include_router(contract_internal_router, prefix="/internal/contract", tags=["internal"])
...
api_router.include_router(legal_commands_router, prefix="/v1/legal", tags=["legal"])
api_router.include_router(benchmark_router, prefix="/v1/benchmark", tags=["benchmark"])
api_router.include_router(template_router, prefix="/v1/template", tags=["template"])
api_router.include_router(compliance_router, prefix="/v1/compliance", tags=["compliance"])
