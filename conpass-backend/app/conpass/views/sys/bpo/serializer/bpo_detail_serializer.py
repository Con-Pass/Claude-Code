...
class BpoDetailRequestBodySerializer(serializers.Serializer):
    """
    表示用(GET)
    """
...
class BpoDetailEditRequestBodySerializer(serializers.Serializer):
    """
    更新処理用(POST)
    """
    id = serializers.IntegerField()  # PK
...
class BpoDetailResponseSerializer(serializers.Serializer):
...
class BpoDetailResponseBodySerializer(serializers.Serializer):
    """
    ...
    response = BpoDetailResponseSerializer()


class BpoCorrectionDetailRequestBodySerializer(serializers.Serializer):
    """
    表示用(GET)
    """
    id = serializers.IntegerField()  # PK
...
class BpoCorrectionDetailEditRequestBodySerializer(serializers.Serializer):
    """
    更新処理用(POST)
    """
    id = serializers.IntegerField()  # PK
...
class BpoCorrectionDetailResponseSerializer(serializers.Serializer):
    id = serializers.IntegerField()
    name = serializers.CharField()
    body = serializers.CharField()
...
class BpoCorrectionDetailResponseBodySerializer(serializers.Serializer):
    """
    response body serializer
    """
    def __init__(self, data):
    ...
    response = BpoCorrectionDetailResponseSerializer()
