...
class SysCorporateDetailRequestBodySerializer(serializers.Serializer):
...
class SysCorporateDetailSerializer(serializers.Serializer):
    id = serializers.IntegerField()  # ID
...
class SysCorporateDetailResponseSerializer(serializers.Serializer):
    corporate = SysCorporateDetailSerializer()
...
class SysCorporateDetailResponseBodySerializer(serializers.Serializer):
    """
    ...
    response = SysCorporateDetailResponseSerializer()
